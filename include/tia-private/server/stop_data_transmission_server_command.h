...
{
public:
    StopDataTransmissionServerCommand (ConnectionID const connection_id, DataServer& data_server, WriteSocket& socket) : connection_id_ (connection_id), socket_ (socket), data_server_ (data_server) {}
