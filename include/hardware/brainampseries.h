...
class BrainAmpSeries : public HWThread
{
  ...
  private:
    ...
    */
    ...
    bool OpenUSBDevice();
    boost::uint32_t GetNrOfSimilarConnectedAmps();
    void checkHighestChannelNr(boost::uint32_t nr_Amps);
  ...
  private:
    ...
    static const std::string hw_trigger_value;   ///< xml-tag hardware: trigger hold value
